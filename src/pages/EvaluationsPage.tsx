...
import { Paper, Typography, Box, Card, CardContent, Avatar, Chip, Button, TextField, Divider, List, ListItem, ListItemText, IconButton, CardHeader, ToggleButton, ToggleButtonGroup } from '@mui/material';
...
const studentDetailedTasks: { [key: number]: Task[] } = {
    1: [{ title: 'التقرير الأول', grade: 5 }, { title: 'تصميم الواجهة', grade: 4 }, { title: 'بناء المكونات', grade: 5 }],
    2: [{ title: 'تحليل النظام', grade: 5 }, { title: 'التقرير الثاني', grade: 5 }],
...
const EvaluationsPage: React.FC = () => {
    ...
    return (
        <Paper sx={{ p: { xs: 1, sm: 2, md: 3 }, width: '100%', backgroundColor: 'grey.50' }}>
            ...
            <Typography variant="body1" color="text.secondary" sx={{ mb: 4 }}>استعراض سريع لجميع الطلاب. انقر على بطاقة الطالب لعرض تقييمه التفصيلي.</Typography>
            <Box sx={{ display: 'flex', flexWrap: 'wrap', gap: 3 }}>
